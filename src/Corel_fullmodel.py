...
def main(reps, pretrained_w_path, do_module1, init_seed=0, load_t=0, num_epochs=200,
    ...
    X_path=osp.join(res_root, 'datasets/corel5k/Xaug_b01c.npy')
    Y_path=osp.join(res_root, 'datasets/corel5k/Y.npy')
    ...
    try:
        ...
        for seed in np.arange(reps)+init_seed:            
            ...
            Yaug_train_val = data_aug(Y_train_val, mode='aug', isMat='Y')
